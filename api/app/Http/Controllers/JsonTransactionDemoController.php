...
class JsonTransactionDemoController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        if (0 === strcasecmp($request->method(), 'get')) {
            return view('v1.json-transaction-demo');
        }
        ...
        $response = Http::post(route('api.v1.third-party.create-transactions'), $postData);
