...
{
    public function store(Transaction $transaction, TransactionStatusService $statusService, Request $request)
    {
        ...
        $childTransaction = $statusService->markPaufenTransactionAsPartialSuccess($transaction, $request->amount, auth()->user()->realUser());
