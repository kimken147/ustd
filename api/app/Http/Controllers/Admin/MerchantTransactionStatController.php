...
class MerchantTransactionStatController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $selfTransactionStats = $this->statRepository->getSelfTransactionStats($users->pluck('id'), 'to_id');
        ...
        $users = $users->map(function (User $user) use ($selfTransactionStats, $today, $yesterday) {
            ...
            $descendantTransactionStats = $this->statRepository->getDescendantTransactionStats($descendantIds, 'to_id');
