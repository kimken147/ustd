...
class AgencyWithdrawDemoController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        if (0 === strcasecmp($request->method(), 'get')) {
            return view('v1.agency-withdraw-demo');
        }
        ...
        if (!$merchant->withdraw_enable) {
            return $this->back(['agency_withdraw_enable' => '代付未启用']);
        }
        ...
        $response = Http::post(route('agency-withdraws.store'), $postData);
