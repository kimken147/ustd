...
class EasyRich extends ThirdChannel
{
    //Log名称
    public $log_name   = 'EasyRich';
    public $type    = 1; //1:代收付 2:纯代收 3:纯代付

    //回调地址
    public $notify    = '';
    public $depositUrl   = 'https://easyrich.cc/Apipay';
    public $xiafaUrl   = 'https://easyrich.cc/Apipay';
    public $daifuUrl   = 'https://easyrich.cc/Apipay';
    public $queryDepositUrl = 'https://easyrich.cc/Apipay';
    public $queryDaifuUrl  = 'https://easyrich.cc/Apipay';
    public $queryBalanceUrl = 'https://easyrich.cc/Apipay';
    ...
    public function sendDeposit($data)
    {
        ...
        if (isset($row['status']) && in_array($row['status'], [1])) {
            ...
            $ret = [
                ...
                'receiver_bank_name' => $data["bank"] ?? "",
                'receiver_account' => $data["bankaccount"] ?? "",
                'receiver_bank_branch' => $data["subbank"] ?? "",
            ];
