...
class NSPay extends ThirdChannel
{
    //Log名称
    ...
    //回调地址
    public $notify    = '';
    public $depositUrl   = 'https://nicepays.cc/Pay_Index.html';
    public $xiafaUrl   = '';
    public $daifuUrl   = 'https://nicepays.cc/withdraw/order';
    public $queryDepositUrl    = '';
    public $queryDaifuUrl  = 'https://nicepays.cc/withdraw/order/query';
    public $queryBalanceUrl = 'https://nicepays.cc/Pay_queryAmt.html';
    ...
    public function sendDeposit($data)
    {
        ...
        if (isset($data['request']->real_name) && $data['request']->real_name != '') {
            $postBody['pay_productname'] =  $data['request']->real_name;
            $postBody['subject'] =  $data['request']->real_name;
        }
    ...
    public function makesign($body, $key)
    {
        ...
        unset($filtered_params["sign"], $filtered_params["pay_md5sign"], $filtered_params["pay_productname"], $filtered_params["subject"], $filtered_params["data_type"]);
