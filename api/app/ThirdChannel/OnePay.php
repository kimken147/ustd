...
class OnePay extends ThirdChannel
{
    //Log名称
    public $log_name   = 'OnePay';
    public $type    = 1; //1:代收付 2:纯代收 3:纯代付

    //回调地址
    public $notify    = '';
    public $depositUrl   = 'https://api.uphyceaemwy.com/api/payment/v1/deposit/create';
    public $xiafaUrl   = 'https://api.uphyceaemwy.com/api/payment/v1/purchase';
    public $daifuUrl   = 'https://api.uphyceaemwy.com/api/payment/v1/withdraw/create';
    public $queryDepositUrl = 'https://api.uphyceaemwy.com/api/payment/v1/query-shipping';
    public $queryDaifuUrl  = 'https://api.uphyceaemwy.com/api/payment/v1/withdraw/query';
    public $queryBalanceUrl = 'https://api.uphyceaemwy.com/api/payment/v1/merchant/info';
    ...
    public function sendDeposit($data)
    {
        ...
        $post = [
            ...
            'currency_type'          => 1,
            'payment_type'           => $data["key2"] ?? $this->channelCodeMap[$this->channelCode],
        ...
        if (isset($row['code']) && in_array($row['code'], ['0'])) {
            $data = $row["data"];
            $ret = [
                'pay_url'      => $data['redirect_url'] ?? "",
                'receiver_name' => $data["payee_name"] ?? "",
                'receiver_bank_name' => $data["payee_bank_name"] ?? "",
                'receiver_account' => $data["payee_account_number"] ?? "",
                'receiver_bank_branch' => $data["payee_branch_name"] ?? "",
            ];
    ...
    public function sendDaifu($data)
    {
        ...
        $post_data = [
            ...
            'bank_number'        => $data['request']->bank_card_number,
            'real_name'   => $data['request']->bank_card_holder_name,
