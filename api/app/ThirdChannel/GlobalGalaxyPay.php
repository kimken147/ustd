...
class GlobalGalaxyPay extends ThirdChannel
{
    //Log名称
    public $log_name   = 'GlobalGalaxyPay';
    public $type    = 1; //1:代收付 2:纯代收 3:纯代付

    //回调地址
    public $notify    = '';
    public $depositUrl   = 'https://tufpay.galaxy-api.com/api/transfer';
    public $xiafaUrl   = 'https://tufpay.galaxy-api.com/payment';
    public $daifuUrl   = 'https://tufpay.galaxy-api.com/api/daifu';
    public $queryDepositUrl    = 'https://tufpay.galaxy-api.com/transaction';
    public $queryDaifuUrl  = 'https://tufpay.galaxy-api.com/api/query';
    public $queryBalanceUrl = 'https://tufpay.galaxy-api.com/api/me';
