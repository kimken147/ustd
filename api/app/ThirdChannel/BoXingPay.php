...
class BoXingPay extends ThirdChannel
{
    //Log名称
    public $log_name   = 'BoXingPay';
    ...
    public function sendDeposit($data)
    {
        ...
        try {
            ...
            $row = json_decode(json_decode($response->getBody(), true), true);
        } catch (\Exception $e) {
    ...
    public function queryDaifu($data)
    {
        ...
        try {
            ...
            $message = $e->getMessage();
            Log::error(self::class, compact('data', 'postBody', 'message'));
            return ['success' => false, 'status' => Transaction::STATUS_PAYING, "msg" => $e->getMessage()];
        }
        ...
        return ['success' => false, 'status' => Transaction::STATUS_PAYING, "msg" => $row["msg"] ?? ""];
    }
