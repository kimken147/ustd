...
class JinWang extends ThirdChannel
{
    //Log名称
    public $log_name = 'JinWang';
    public $type = 1; //1:代收付 2:纯代收 3:纯代付

    //回调地址
    public $notify = '';
    public $depositUrl = 'https://pay.jinwang178.com/api/pay/create_order';
    public $xiafaUrl = '';
    public $daifuUrl = 'https://pay.jinwang178.com/api/trans/create_order';
    ...
    public $queryBalanceUrl = 'https://pay.jinwang178.com/api/query/query_balance';
