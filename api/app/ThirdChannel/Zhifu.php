...
class Zhifu extends ThirdChannel
{
    //Log名称
    public $log_name   = 'Zhifu';
    public $type    = 1; //1:代收付 2:纯代收 3:纯代付－

    //回调地址
    public $notify    = '';
    public $depositUrl   = 'https://zhifu.meiannaisi.com/mapi.php';
    public $xiafaUrl   = '';
    public $daifuUrl   = '';
    public $queryDepositUrl    = '';
    public $queryDaifuUrl  = '';
    public $queryBalanceUrl = 'https://zhifu.meiannaisi.com/api.php';
