...
class BFPay extends ThirdChannel
{
    //Log名称
    public $log_name = "BFPay";
    public $type = 1; //1:代收付 2:纯代收 3:纯代付

    //回调地址
    public $notify = "";
    public $depositUrl = "https://baofei.galaxy-api.com/api/transfer";
    public $xiafaUrl = "https://baofei.galaxy-api.com/payment";
    public $daifuUrl = "https://baofei.galaxy-api.com/api/daifu";
    public $queryDepositUrl = "https://baofei.galaxy-api.com/transaction";
    public $queryDaifuUrl = "https://baofei.galaxy-api.com/api/query";
    public $queryBalanceUrl = "https://baofei.galaxy-api.com/api/me";
    ...
    public function sendDeposit($data)
    {
        ...
        $post = [
            ...
            "bank_code" =>
                $this->channelCodeMap[$data["request"]->channel_code],
            "callback_url" => $data["callback_url"],
            "return_url" => isset($data["request"]->return_url)
                ? $data["request"]->return_url
                : "https://google.com",
        ];
    ...
    public function sendDaifu($data)
    {
        ...
        $post_data = [
            ...
            "amount" => $data["request"]->amount,
            "bank" =>
                $this->channelCodeMap[$data["request"]->bank_name] ?? "gcash",
    ...
    public function queryDaifu($data)
    {
        ...
        $status = $return_data["status"];
        Log::debug(
            "BFPay daifu $orderNumber",
            compact("orderNumber", "return_data")
        );
    ...
    public function queryBalance($data)
    {
        ...
        try {
            ...
            Log::error(self::class . "/queryBalance", compact("message"));
            return [
                "success" => false,
            ];
        }
