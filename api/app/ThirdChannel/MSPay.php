...
class MSPay extends ThirdChannel
{
    //Log名称
    public $log_name   = 'MSPay';
    public $type    = 1; //1:代收付 2:纯代收 3:纯代付

    //回调地址
    public $notify    = '';
    public $depositUrl   = 'https://payment.mspays.xyz/{merchant}/orders/v3/scan';
    ...
    public function sendDeposit($data)
    {
        ...
        if (isset($return_data['result']) && $return_data['result'] == true) {
            ...
            $ret = [
                'pay_url' => $return_data['data']['httpsUrl'],
            ];
        } else {
