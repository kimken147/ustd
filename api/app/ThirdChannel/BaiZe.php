...
class BaiZe extends ThirdChannel
{
    //Log名称
    public $log_name   = 'BaiZe';
    public $type    = 1; //1:代收付 2:纯代收 3:纯代付－

    //回调地址
    public $notify    = '';
    public $depositUrl   = 'http://206.238.198.228/gateway/pay/api';
    public $xiafaUrl   = '';
    public $daifuUrl   = 'http://206.238.198.228/withdraw/order';
    public $queryDepositUrl    = '';
    public $queryDaifuUrl  = 'http://206.238.198.228/withdraw/order/query';
    public $queryBalanceUrl = 'http://206.238.198.228/gateway/pay/query_balance';
    ...
    public function sendDeposit($data)
    {
        ...
        $postBody = [
            ...
            "ip" => $data['client_ip'] ?? '168.168.168.168',
            'attach' => 'attach',
        ];
    ...
    public function callback($request, Transaction $transaction, ThirdChannelModel $thirdChannel)
    {
        ...
        //代收检查状态
        if (in_array($data["orderStatus"], ['2']) && in_array($transaction->type, [1])) {
            return ['success' => true];
        }
