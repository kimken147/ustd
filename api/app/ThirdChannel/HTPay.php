...
{
    //Log名称
    public $log_name = "HTPay";
    public $type = 1; //1:代收付 2:纯代收 3:纯代付

    //回调地址
    public $notify = "";
    public $depositUrl = "https://htpay.galaxy-api.com/api/transfer";
    public $xiafaUrl = "https://htpay.galaxy-api.com/payment";
    public $daifuUrl = "https://htpay.galaxy-api.com/api/daifu";
    public $queryDepositUrl = "https://htpay.galaxy-api.com/transaction";
    public $queryDaifuUrl = "https://htpay.galaxy-api.com/api/query";
    public $queryBalanceUrl = "https://htpay.galaxy-api.com/api/me";
    ...
    {
        $this->key = $data["key"];
        $channelCode = $data["request"]->channel_code;
        $post = [
