...
class HaoHui extends ThirdChannel
{
    //Log名称
    ...
    //回调地址
    public $notify    = '';
    public $depositUrl   = 'https://xyz.bingopay888.com/api/pay_request';
    ...
    public function sendDeposit($data)
    {
        ...
        $post = [
            ...
            'payType' => $this->channelCodeMap['BANK_CARD'],
