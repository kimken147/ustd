<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Order Failed</title>
...
<body><div class="card"><h2>Order Failed</h2><p>Order No.: {{ $transaction->system_order_number }}</p><p>This order has failed, please create a new order</p></div></body></html>
