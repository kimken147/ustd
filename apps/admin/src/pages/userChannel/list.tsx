...
const UserChannelAccountList: FC = () => {
  ...
  const { providerName: name } = useTerminology();
  ...
  const { show: showUpdateModal, modalProps } = useUpdateModal({
    formItems: [
      ...
      { label: t('fields.dailyTotal'), name: 'daily_total', children: <InputNumber className="w-full" /> },
      { label: t('fields.dailyTransactionCountTotal'), name: 'daily_transaction_count_total', children: <InputNumber className="w-full" min={0} precision={0} /> },
      { label: t('fields.withdrawDailyTotal'), name: 'withdraw_daily_total', children: <InputNumber className="w-full" /> },
      { label: t('fields.withdrawDailyTransactionCountTotal'), name: 'withdraw_daily_transaction_count_total', children: <InputNumber className="w-full" min={0} precision={0} /> },
      ...
      { label: t('fields.monthlyTotal'), name: 'monthly_total', children: <InputNumber className="w-full" /> },
      { label: t('fields.monthlyTransactionCountTotal'), name: 'monthly_transaction_count_total', children: <InputNumber className="w-full" min={0} precision={0} /> },
      { label: t('fields.withdrawMonthlyTotal'), name: 'withdraw_monthly_total', children: <InputNumber className="w-full" /> },
      { label: t('fields.withdrawMonthlyTransactionCountTotal'), name: 'withdraw_monthly_transaction_count_total', children: <InputNumber className="w-full" min={0} precision={0} /> },
      { label: t('fields.monthlyReceiveCountLimit'), name: 'monthly_transaction_count_limit', children: <InputNumber className="w-full" min={0} precision={0} /> },
      { label: t('fields.monthlyPayoutCountLimit'), name: 'withdraw_monthly_transaction_count_limit', children: <InputNumber className="w-full" min={0} precision={0} /> },
