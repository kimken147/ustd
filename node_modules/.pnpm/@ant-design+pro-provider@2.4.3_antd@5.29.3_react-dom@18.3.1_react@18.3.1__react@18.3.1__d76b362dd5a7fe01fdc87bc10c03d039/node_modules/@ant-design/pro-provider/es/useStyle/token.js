...
export var token = {
  theme: emptyTheme,
  token: _objectSpread(_objectSpread({}, defaultToken), theme === null || theme === void 0 ? void 0 : (_theme$defaultAlgorit = theme.defaultAlgorithm) === null || _theme$defaultAlgorit === void 0 ? void 0 : _theme$defaultAlgorit.call(theme, theme === null || theme === void 0 ? void 0 : theme.defaultSeed)),
  hashId: "pro-".concat(hashCode(JSON.stringify(defaultToken)))
};
export var useToken = function useToken() {
  return token;
};
export var darkAlgorithm = function darkAlgorithm() {
  var _theme$defaultAlgorit2;
  return _objectSpread(_objectSpread({}, defaultToken), theme === null || theme === void 0 ? void 0 : (_theme$defaultAlgorit2 = theme.defaultAlgorithm) === null || _theme$defaultAlgorit2 === void 0 ? void 0 : _theme$defaultAlgorit2.call(theme, theme === null || theme === void 0 ? void 0 : theme.defaultSeed));
};
export var defaultAlgorithm = function defaultAlgorithm() {
  var _theme$defaultAlgorit3;
  return _objectSpread(_objectSpread({}, defaultToken), theme === null || theme === void 0 ? void 0 : (_theme$defaultAlgorit3 = theme.defaultAlgorithm) === null || _theme$defaultAlgorit3 === void 0 ? void 0 : _theme$defaultAlgorit3.call(theme, theme === null || theme === void 0 ? void 0 : theme.defaultSeed));
};
export var compactAlgorithm = function compactAlgorithm() {
  var _theme$defaultAlgorit4;
  return _objectSpread(_objectSpread({}, defaultToken), theme === null || theme === void 0 ? void 0 : (_theme$defaultAlgorit4 = theme.defaultAlgorithm) === null || _theme$defaultAlgorit4 === void 0 ? void 0 : _theme$defaultAlgorit4.call(theme, theme === null || theme === void 0 ? void 0 : theme.defaultSeed));
};