import { BaseKey, IResourceItem, RouteAction } from "../../../interfaces";
export declare type UseResourcePropsType = {
    /**
 ...
 */
export declare const useResource: ({ resourceName: propResourceName, resourceNameOrRouteName, recordItemId, }?: UseResourcePropsType) => UseResourceReturnType;
export {};
