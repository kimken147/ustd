...
import { BaseRecord, CreateResponse, GetOneResponse, HttpError, LiveModeProps, RedirectAction, SuccessErrorNotification, MetaDataQuery, UpdateResponse, MutationMode, BaseKey, IQueryKeys, FormAction } from "../../interfaces";
...
export declare type UseFormReturnType<TData extends BaseRecord = BaseRecord, TError extends HttpError = HttpError, TVariables = {}> = {
    ...
    redirect: (redirect: RedirectAction, idFromFunction?: BaseKey | undefined) => void;
};
/**
