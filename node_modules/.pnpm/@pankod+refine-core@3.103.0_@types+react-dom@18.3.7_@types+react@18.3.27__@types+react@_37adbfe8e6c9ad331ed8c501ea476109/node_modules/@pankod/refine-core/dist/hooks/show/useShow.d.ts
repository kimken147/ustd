...
import { BaseRecord, GetOneResponse, SuccessErrorNotification, MetaDataQuery, LiveModeProps, BaseKey, HttpError } from "../../interfaces";
 ...
 */
export declare const useShow: <TData extends BaseRecord = BaseRecord, TError extends HttpError = HttpError>({ resource: resourceFromProp, id, successNotification, errorNotification, metaData, liveMode, onLiveEvent, dataProviderName, queryOptions, }?: useShowProps<TData, TError>) => useShowReturnType<TData>;
