...
import { GetOneResponse, HttpError, BaseRecord, BaseKey, MetaDataQuery, LiveModeProps, SuccessErrorNotification } from "../../interfaces";
 ...
 *
 */
export declare const useOne: <TData extends BaseRecord = BaseRecord, TError extends HttpError = HttpError>({ resource, id, queryOptions, successNotification, errorNotification, metaData, liveMode, onLiveEvent, liveParams, dataProviderName, }: UseOneProps<TData, TError>) => QueryObserverResult<GetOneResponse<TData>, unknown>;
