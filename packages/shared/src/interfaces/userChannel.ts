// BaseRecord interface from refine-core - defined locally to avoid external dependency
...
export interface UserChannel extends BaseRecord {
    ...
    daily_total: string;
    daily_transaction_count_limit: number | null;
    daily_transaction_count_total: number;
    withdraw_daily_limit: string;
    withdraw_daily_total: string;
    withdraw_daily_transaction_count_limit: number | null;
    withdraw_daily_transaction_count_total: number;
    monthly_status: boolean;
    monthly_limit: string;
    monthly_limit_value: string;
    monthly_total: string;
    monthly_transaction_count_limit: number | null;
    monthly_transaction_count_total: number;
    withdraw_monthly_limit: string;
    withdraw_monthly_total: string;
    withdraw_monthly_transaction_count_limit: number | null;
    withdraw_monthly_transaction_count_total: number;
